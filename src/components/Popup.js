    ...
    {...framerPage}>
      <div className='flex items-center justify-center h-full'>
        <div className='absolute top-0 right-0 cursor-pointer group' onClick={openPopup}>
          <img className='w-8 m-6 md:group-hover:rotate-90 transition-transform duration-300 ' src={cross}  />
        </div>
        ...
        <div className='hidden md:block absolute top-[50vh] right-0 cursor-pointer group' onClick={()=>handleChangeImage(1)}>
          <img className='w-8 m-6 animate-wiggle md:hover:animate-slide duration-300 z-20 ' src={arrowR} />
        </div>
        <div className='hidden md:block absolute top-[50vh] left-0 cursor-pointer group' onClick={()=>handleChangeImage(-1)}>
          <img className='w-8 m-6 animate-wiggle md:hover:animate-slide duration-300 z-20  ' src={arrowL} />
        </div>
      </div>
    </motion.div>
  )
