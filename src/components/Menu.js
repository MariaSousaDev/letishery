...
export default function Menu() {
  ...
  return (
    <div className='fixed w-screen md:w-[26vw] lg:w-[22vw] xl:w-[15vw] h-14 z-20 md:border md:border-r-sunglo-200 md:h-screen md:flex md:items-center md:justify-center md:flex-col md:bg-[url("https://i.ibb.co/wp0BJfL/00-leti-bg0.png")] select-none'>
