  ...
  return (
      <div className="flex flex-col font-poppins tracking-wider bg-gradient-to-r from-sunglo-50 to-transparent">
        <div className='relative xl:w-[80vw] xl:self-center '>
          ...
          <img className='fixed top-14 md:top-0 left-0 md:left-[26vw] lg:left-[22vw] -z-10 max-h-full rotate-180' src={BGFlower} alt="" />
          <Menu />
          <div className='min-h-[95vh] md:min-h-screen flex p-8 text-center mt-12 md:mt-0'>
              <Outlet/>
          </div>
        </div>
      </div>
